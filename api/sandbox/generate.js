...
// Handles POST /api/sandbox/generate
...
export default async function handler(req, res) {
  // Support CORS if running cross-origin locally
  ...
  if (!apiKey || apiKey === 'YOUR_GEMINI_API_KEY') {
    ...
    return res.status(200).json(getFallbackData(subject, lighting, angle, custom_nuances, 'GEMINI_API_KEY not set'));
  }
